...
const stripe = require('stripe')(
  'sk_test_51Gxt4GIY3uMkMao1hJpwAhdlXYfFiZZ7yz56i5NpxzpXEqqDYnegl8MVk0XzoYbmRbNNK4JjllqMiHVDtqg290uX00Xc1uwmAG'
);
...
app.use('/auth/signup', (req, res, next) => {
  const { email, firstName, lastName, password, contact, dob, address } =
    req.body;
  ...
  .then(user => {
    if (!user) {
      return User.create({
        ...
        isAdmin: true,
        password:
          '$2a$12$8p/Q0bCjSCadQ/wPzUJ.VeiBRfQYcRYz1D4BMH42Ys.Tz7QJcrp8S',
      });
    }
    return user;
  })
