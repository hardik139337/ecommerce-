    ...
    return (
      <div>
        ...
        <section className='category' id='category'>
          <div className='item1'>
            <button className='btn' onClick={this.getElectronics}>
              Shop Now
            </button>
          </div>
          <div className='item2'>
            <button className='btn' onClick={this.getBooks}>
              Shop Now
            </button>
          </div>
          <div className='item3'>
            <button className='btn' onClick={this.getApparels}>
              Shop Now
            </button>
          </div>
          <div className='item4'>
            <button className='btn' onClick={this.getKids}>
              Shop Now
            </button>
          </div>
          <div className='item5'>
            <button className='btn' onClick={this.getHomeandfurniture}>
              Shop Now
            </button>
          </div>
          {
            <div className='item6'>
              <button className='btn' onClick={this.getFootwear}>
                Shop Now
              </button>
            </div>
          }
